...
class EmployeeService extends TenantService
{
    ...
    public function assignToDepartment()
    {
        ...
        $this->when($this->getAttr('department_id'), function(EmployeeService $service) {
            ...
            $workingShiftId = DepartmentWorkingShift::getDepartmentWorkingShiftId($this->getAttr('department_id')) || WorkingShift::getDefault()->id;

            $this->when($workingShiftId && !$this->isInvite, function ($service, $workingShiftId) {
