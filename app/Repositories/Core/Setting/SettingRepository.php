...
class SettingRepository extends BaseRepository
{
    ...
    public function getFormattedSettings($context = 'tenant', $settingable_type = null, $settingable_id = 1)
    {
    ...
    public function findAppSettingWithName(string $name, string $context = 'tenant')
    {
