...
Vue.component('app-table-media', require('../tenant/Helpers/TableMedia').default);
Vue.component('star-rating', require('../tenant/Helpers/StarRating').default);
Vue.component('app-custom-field-modal', require('../core/components/modal/CustomFieldModal').default);
